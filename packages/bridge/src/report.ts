...
export interface MachineReport {
  ...
  audio: { microphoneLabel?: string; contextState?: string; contextSampleRate: number; captureSampleRate: number; channels: number; echoCancellation: boolean; noiseSuppression: boolean; autoGainControl: boolean };
...
export function validateMachineReport(candidate: unknown): MachineReport {
  ...
  const physicalAudioKeys = ['microphoneLabel', 'contextState', ...legacyAudioKeys];
