...
function report(hostName, role, options = {}) {
  ...
  return { schemaVersion: 1, capturedAt: new Date().toISOString(), machine: { hostName, os: 'test', architecture: 'test', browserVersion: 'Chromium test', commit: options.commit ?? 'a'.repeat(40) }, evidenceClass, epoch: 1, codec: options.codec ?? quiet, audio: { microphoneLabel: 'Test microphone', contextState: 'running', inputDeviceSampleRate: 48000, inputDeviceChannels: 1, contextSampleRate: 48000, captureSampleRate: 48000, channels: 1, echoCancellation: false, noiseSuppression: false, autoGainControl: false }, queues: { captureHighWaterBytes: 1, captureHighWaterMs: 1, playbackHighWaterBytes: 1, playbackHighWaterMs: 1, discontinuities: 0 }, results, complete, reasonCodes: complete ? [] : ['corpus_incomplete'], qualification: { deadLinkTimeoutMs: 30000, cyrinxDeadlineMs: 5400000, deadline: { startedAtMs: 1000, deadlineAtMs: 5401000, elapsedMs: 100 }, physicalGate: complete ? 'passed' : 'failed', fallback: { codecId: 'quiet', state: 'activated', reasonCode: 'cyrinx_cold_a_to_b_failed' }, cyrinx: { stage: 'quiet', coldReceivePassed: false } }, runner: { machineId: hostName, role, reportTarget: `${hostName}.json`, evidenceClass, tunEvidence: exactTun } };
}
